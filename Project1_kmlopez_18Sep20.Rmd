...
You should have an input on your function that allows the user to choose which endpoint.
  
The user should be able to specify both the teamID and endpoint in your wrapper function. Essentially it should be a single function that the user can use to call any of the API endpoints that you have written functions for. This function should allow them to specify any of the possible inputs as well.  

...
## Repo
Rename the created file as README.md (notice this is .md not .Rmd! - your outputted document should be a .md file) and use this as the README for your repo. This should make the website for the repo correspond to the output of your .Rmd file (essentially). Note: You can use the `render` function to output to a specific file name rather than changing it manually.  

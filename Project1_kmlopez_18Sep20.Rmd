...
franchise <- function(){
  ...
  #in line 3- franchise<- fromJSON(franchise, flatten= TRUE), I added simplifyDataFrame = TRUE, to make the output a little neater. Also added franchise<- as.data.frame(franchise) as the next line.
